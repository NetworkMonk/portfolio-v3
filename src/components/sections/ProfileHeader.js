              ...
              <div className="h-full flex flex-col items-center md:p-10 md:order-1">
                <div className="flex-1 flex items-center py-20 relative">
                  <div>
                    ...
                    <h2 className="text-4xl font-semibold tracking-wide mt-10 in-up-right" style={{animationDelay: "0.5s"}}>
                      A full stack web application developer and technology
                      leader.
                    </h2>
                    <div className="flex flex-col md:flex-row gap-5 mt-10 in-up-right" style={{animationDelay: "1s"}}>
                      <h3>
                        <svg
                    ...
                    <div className="mt-10 in-up-right" style={{animationDelay: "1.5s"}}>

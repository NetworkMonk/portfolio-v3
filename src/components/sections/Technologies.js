      ...
      <Container>
        <InView>
          <div className="md:p-10">
            <h2 className={`${josefin.className} text-3xl tracking-wider in-up-right`} style={{animationDelay: "0.5s"}}>
              Technologies
            </h2>
            <p className="my-5 text-sm in-up-right text-gray-400" style={{animationDelay: "1s"}}>
              I have experience working with all the following technologies.
              <br />
              If a technology isn&apos;t explicitly listed here, it doesn&apos;t
              mean I don&apos;t work with it. There&apos;s just too much to list
              in a meaningful way!
            </p>
